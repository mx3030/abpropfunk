...
import Step0 from '/src/tasks/task2/steps/step0/step0.jsx'
import Step1 from '/src/tasks/task2/steps/step1/step1.jsx'
import Step2 from '/src/tasks/task2/steps/step2/step2.jsx'
import Step3 from '/src/tasks/task2/steps/step3/step3.jsx'
// main config files
import { step0_data, step0_initSol } from '/src/tasks/task2/steps/step0/step0_data.jsx'
import { step1_data, step1_initSol } from '/src/tasks/task2/steps/step1/step1_data.jsx'
import { step2_data, step2_initSol } from '/src/tasks/task2/steps/step2/step2_data.jsx'
import { step3_data, step3_initSol } from '/src/tasks/task2/steps/step3/step3_data.jsx'
import { step4_data, step4_initSol } from '/src/tasks/task2/steps/step4/step4_data.jsx'
// additional help files
import { help2A_data, help2A_initSol } from '/src/tasks/task2/steps/step2/help2/help2_data.jsx'
...
export default function Task1(){
    ...
    //--------------------------------------------------------------------------------------
    const [solData, setSolData] = useLocalStorageState('solDataTask2',{
        defaultValue: {
            step0_initSol,
            step1_initSol,
            step2_initSol,
    ...
    //--------------------------------------------------------------------------------------
    const [progressData, setProgressData] = useLocalStorageState('progressDataTask2', {
        defaultValue: {
    ...
    const [miscData, setMiscData] = useLocalStorageState('miscDataTask2',{
        defaultValue: {
            isPortrait: false,
    ...
    //--------------------------------------------------------------------------------------
    const [tableData, setTableData] = useLocalStorageState('tableDataTask2',{
        defaultValue: []
    });
    ...
    //--------------------------------------------------------------------------------------
    const [ggbData, setGGBData] = useLocalStorageState('ggbDataTask2',{
        defaultValue: {
            points: [],
            lines: []
        }
    ...
    //--------------------------------------------------------------------------------------
    const [inputData, setInputData] = useLocalStorageState('inputDataTask2',{
        defaultValue: {}
    });

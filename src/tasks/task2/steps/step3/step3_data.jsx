...
const clozeText = "Ein <Koordinatensystem> wird verwendet, um eine Zuordnung zwischen zwei verschiedenen Dingen grafisch darzustellen. Ganz allgemein wird dabei einem <x-Wert> von der einen Sache, ein y-Wert von der anderen Sache <zugeordnet> . Man drückt das durch einen <Punkt> im Koordinatensystem aus. Bei unserem Versuch, eignet sich z.B. die <Anzahl> von Papierseiten als x-Wert und die <Höhe> als y-Wert. Die <Beschriftung> der Achsen wird deshalb geändert."
...
export const step3_data = {
    ...
    instructions: [
        ...
        {
            text: "Achte auf die Beschriftung der Achsen und trage die entsprechenden Messwerte aus der Tabelle als Punkte in das Koordinatensystem ein. Verwende falls notwendig die Regler um die Achsen des Koordinatensystems anzupassen.",
            display: 'step3A',
            check: 'step3B',
            help: false,
            displayHelp: false, 
    ...
    cloze: {
        ...
        action: ['Anzahl','Höhe in [mm]'], // action on solve
    ...
    checker: [
        {
            ...
            sol: ['solData','step2B_updater1'], // use solution from step2B_updater1 for checking
